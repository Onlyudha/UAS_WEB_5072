        ...
        <div class="offcanvas offcanvas-start" id="offcanvas">
            <div class="offcanvas-body">
                <ul class="list-unstyled">
                    <li class="mb-2 ms-2"><a href="<?= base_url('dosen/index'); ?>" class="w3-bar-item w3-button">Dashboard</a></li>
                    <li class="mb-2 ms-2"><a href="<<?= base_url('dosen/input_nilai'); ?>" class="w3-bar-item w3-button">Update Nilai</a></li>
                </ul>
            </div>
        </div>

                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($nilai['id_nilai']): ?>
                            <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editNilaiModal"
                                onclick="setEditForm(<?= htmlspecialchars(json_encode($nilai)); ?>)">
                                <i class="bi bi-pencil-fill"></i>
                            </button>
                            <button class="btn btn-danger btn-sm"
                                onclick="confirmDelete('<?= base_url('dosen/hapus_nilai/' . $nilai['id_nilai']); ?>', '<?= $nilai['nama_mahasiswa']; ?>')">
        ...
        <form method="post" action="<?= base_url('dosen/tambah_nilai'); ?>" class="needs-validation" novalidate>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" name="tugas" placeholder="Nilai Tugas (0-100)" class="form-control mb-2"
                        min="0" max="100" required>
                    <input type="number" name="responsi" placeholder="Nilai Responsi (0-100)" class="form-control mb-2"
                        min="0" max="100" required>
                    <input type="number" name="uts" placeholder="Nilai UTS (0-100)" class="form-control mb-2" min="0"
                        max="100" required>
                    <input type="number" name="uas" placeholder="Nilai UAS (0-100)" class="form-control mb-2" min="0"
                        max="100" required>
                </div>
        ...
        <form method="post" action="<?= base_url('dosen/edit_nilai'); ?>" class="needs-validation" novalidate>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" id="edit-tugas" name="tugas" placeholder="Nilai Tugas (0-100)"
                        class="form-control mb-2" min="0" max="100" required>
                    <input type="number" id="edit-responsi" name="responsi" placeholder="Nilai Responsi (0-100)"
                        class="form-control mb-2" min="0" max="100" required>
                    <input type="number" id="edit-uts" name="uts" placeholder="Nilai UTS (0-100)"
                        class="form-control mb-2" min="0" max="100" required>
                    <input type="number" id="edit-uas" name="uas" placeholder="Nilai UAS (0-100)"
                        class="form-control mb-2" min="0" max="100" required>
                </div>
                <div class="modal-footer">

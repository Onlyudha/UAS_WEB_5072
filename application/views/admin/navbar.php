        ...
        <div class="offcanvas offcanvas-start" id="offcanvas">
            <div class="offcanvas-body">
                ...
                <li class="mb-2 ms-2"><a href="<?= base_url('index.php/admin'); ?>" class="w3-bar-item w3-button">Dashboard</a></li>
                    <li class="mb-2 ms-2"><a href="<?= base_url('admin/kelola_dosen'); ?>" class="w3-bar-item w3-button">Daftar Dosen</a></li>
                    <li class="mb-2 ms-2"><a href="<?= base_url('admin/kelola_mahasiswa'); ?>" class="w3-bar-item w3-button">Daftar Mahasiswa</a></li>
                    <li class="mb-2 ms-2"><a href="#" class="w3-bar-item w3-button">Daftar Mata Kuliah</a></li>
                </ul>
            </div>
        </div>
